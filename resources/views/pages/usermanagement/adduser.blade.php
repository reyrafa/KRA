<x-app-layout>
    ...
    <div class="row mt-5 ">
        ...
        <div class="col-md-10 bg-white shadow-xl rounded overflow-hidden">
            <form action="/usermanagement/add/systemuser" method="POST">
                @csrf
            <div class="row p-2 mt-3">
                <div class="col-md-12 mb-3">
                    <h3 class="" style="text-align: center; font-size:2em;" class="block uppercase tracking-wide text-gray-700 font-bold mb-2">ADD OIC OFFICER</h3>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select required
                        ...
                        <?php 
                            $id = DB::table('position')->pluck('id', 'positionDesc');
                            foreach($id as $position=>$id){
                                echo "<option value=$id {{ old('id')==$id? 'selected':''}}>$position</option>"; 
                            }
                        ?>
                    </select>
                </div>
                ...
                <div class="col-md-3"></div>
                <div class="col-md-3 mb-3">
                    <x-jet-button id="submit" type="submit">Create User</x-jet-button>
                </div>
            </div>
            </form>
        </div>
